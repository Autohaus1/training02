sap.ui.define([
	...
	return BaseObject.extend("de.crud.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias de.crud.model.ListSelector
		 */
		 ...
		 * @return {de.crud.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
